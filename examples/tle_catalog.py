...
This example showcases the loading and plotting of the space object states from TLE catalog using the 
``sorts.population.tle_catalog`` module.

This example also propagates the states of an object from the TLE catalog.
'''
import pathlib
import configparser
...
# loads the population from the tle catalog

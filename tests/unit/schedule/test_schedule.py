...
from sorts.schedule import schedule_dataframe, ScheduleKey
...
def test_schedule_by_priority():
    exp_00_sch = schedule_dataframe.from_rows([
    ...
    exp_01_sch = schedule_dataframe.from_rows([
    ...
    exp_02_sch = schedule_dataframe.from_rows([
    ...
    df = schedule_dataframe.schedule_by_priority([exp_00_sch, exp_01_sch, exp_02_sch], [0, 1, 0])

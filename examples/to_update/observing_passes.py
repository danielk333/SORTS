...
from sorts.controller_v1 import Tracker
...
for pi in range(len(passes0[0][0])):
    ...
    if dat is not None:
        axes[0][0].plot(
            states0[0, passes0[0][0][pi].inds],
            states0[1, passes0[0][0][pi].inds],
            states0[2, passes0[0][0][pi].inds],
            "-",
            label=f"pass-{pi}",
        )
    ...
    if dat2 is not None:
        axes[0][0].plot(
            states1[0, passes1[0][0][pi].inds],
            states1[1, passes1[0][0][pi].inds],
            states1[2, passes1[0][0][pi].inds],
            "-",
            label=f"obj2 pass-{pi}",
        )
        ...
        axes[1][1].plot(
            dat2["t"] / 3600.0, 10 * np.log10(dat2["snr"]), "-", label=f"obj2 pass-{pi}"
        )

...
class TestRadarControls(unittest.TestCase):
    ...
    def test_get_control_period_id(self):
        ...
        t               = np.linspace(controller_t0, controller_t0 + 9.0, 10)
        duration        = np.ones(10)*0.5
        ...
        assert controls_ref.get_control_period_id(14)   == -1 # 26s : t > t0 + control_duration

        # test inside of range
        assert controls_ref.get_control_period_id(8)    == 0 # 15s
        assert controls_ref.get_control_period_id(10)   == 2 # 19.5s
        assert controls_ref.get_control_period_id(13)   == 5 # 24s

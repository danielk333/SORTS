    ...
    **Reference:** Markkanen et.al., 1999
    ...
    if N == 1:
        ...
        clibsorts.hard_target_snr_vectorized.argtypes = [
                ...
                ctypes.c_double,
                ctypes.c_double,
                np.ctypeslib.ndpointer(dtype=ctypes.c_double, ndim=range_tx_m.ndim, shape=range_tx_m.shape),
                np.ctypeslib.ndpointer(dtype=ctypes.c_double, ndim=range_rx_m.ndim, shape=range_rx_m.shape),
                ctypes.c_double, 
                ctypes.c_double,
                ctypes.c_double,
                ctypes.c_double,
    ...
    **Reference:** Markkanen et.al., 1999
    ...
    if N == 1:
        ...
        clibsorts.hard_target_diameter_vectorized.argtypes = [
            ...
            ctypes.c_double,
            ctypes.c_double,
            np.ctypeslib.ndpointer(dtype=ctypes.c_double, ndim=diameter.ndim, shape=diameter.shape),
            ctypes.c_int,
        ]
    ...
    **Reference:** D. Kastinen et al.: Radar observability of near-Earth objects with EISCAT 3, 2020
    ...
    if N == 1:
        ...
        clibsorts.doppler_spread_hard_target_snr_vectorized.argtypes = [
            ...
            ctypes.c_double,
            ctypes.c_double,
            np.ctypeslib.ndpointer(dtype=ctypes.c_double, ndim=snr_coh.ndim, shape=snr_coh.shape),
            np.ctypeslib.ndpointer(dtype=ctypes.c_double, ndim=snr_incoh.ndim, shape=snr_incoh.shape),
            ctypes.c_int,
        ]

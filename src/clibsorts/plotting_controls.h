...
struct scheduler_python_functions_struct {
...
typedef struct scheduler_python_functions_struct scheduler_python_functions;

scheduler_python_functions scheduler_python_functions_callback;

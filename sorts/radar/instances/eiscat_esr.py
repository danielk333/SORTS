...
def gen_eiscat_esr():
    ...
    tx_beam32 = alib.esr_32.copy()
    rx_beam32 = alib.esr_32.copy()
    tx_beam42 = alib.esr_42.copy()
    rx_beam42 = alib.esr_42.copy()
    ...
    tx = [TX(                   # 1st TX: 32m
        ...
        lon = lon_esr42,
        alt = alt_esr,
        min_elevation = 75,     # TODO: Fix azimuth and elevation to narrow intervals
        beam = tx_beam42,
        power = 1.0e6,
        bandwidth = 2e6,        # Check
        duty_cycle = 0.25,
